...
export default function Hero() {
  ...
  return (
    <>
      ...
      {/* MEDIUM & LARGE DEVICES (md and up) */}
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-background hidden md:flex">
