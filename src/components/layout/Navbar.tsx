    ...
    <nav className={`fixed top-0 w-full z-[100] transition-all duration-700 ${
      ...
      <div className="container mx-auto px-6 flex justify-between items-center text-foreground">
        ...
        <div className="flex items-center space-x-4 md:space-x-12">
          ...
          <div className="flex items-center space-x-4 border-l border-foreground/10 pl-4 md:pl-6">
            ...
            {/* Desktop CTA */}
            <button className="hidden md:block bg-foreground text-background px-6 py-3 text-[10px] uppercase tracking-[0.2em] font-bold">
              Book a Consultation
            </button>
